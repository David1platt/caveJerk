...
import gameMechanics.movement.LevelReader;
...
public class SaveState {
	...
	static String assembleRecord(Player plyrOne, CoordinateManager playerLoc, int lvlNum, Room currRoom) throws IOException
	{
		//Charset charSet = Charset.forName("UTF-8");
		String plyrRecord = plyrOne.getName() +";" + plyrOne.getHp() + "," + String.valueOf(plyrOne.getArtifactFound()); 
		String plyrInv = ";";
