...
public class Monster implements MonsterAction {
	...
	public String toString() {
		String monVals = this.type + ";" + String.valueOf(this.hp) + ";" + String.valueOf(this.dmg) + ";"
				+ String.valueOf(this.ac) + ";" + String.valueOf(this.combatScore) + ";"
				+ String.valueOf(this.numberattcks);
		return monVals;
	}
