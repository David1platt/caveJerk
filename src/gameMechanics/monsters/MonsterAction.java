...
public interface MonsterAction{
   ...
   //protected void special() {};
    ...
    default int monsterDamage(ArrayList<Monster> monsters, Monster beast)
    {
    	int dmg = 0;
    	switch(beast.getType())
    	{
    	case "goblin":
    		dmg = (((Goblin) beast).goblinSpecial(monsters));
    		break;
    	case "orc":
    ...
    {
    	String[] badWoundMssgs = {" stumbles and takes a deep breath. You see blood flowing freely from deep wounds. It cannot stand up to you much longer. "," glares at you with madness in its eyes as it clutches a brutal wound. "," shakes in a terrible trembling fit as it coughs on its own blood. "};
    	String lghtWound = "\nThe " + beast.getType() + " is bruised and battered, but stares you down, roaring in fury.";
