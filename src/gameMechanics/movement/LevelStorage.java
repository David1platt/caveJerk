...
public class LevelStorage 
{
	...
	private CoordinateManager location, 
	lvlOneDimensions = new CoordinateManager(7, 7), 
	lvlTwoDimensions = new CoordinateManager(8, 9),
	lvlThreeDimensions = new CoordinateManager(12, 12);
	...
	/******
	 * *constructor builds the set of game levels
	 * *uses the gameLevels to save a list of room lists
	 * *sets up room lists and stores them in gameLevels
	 * *reads levels into game
	 * *@throws IOException
	 ******/
