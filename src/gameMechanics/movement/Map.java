...
public class Map {
	...
	private CoordinateManager location, lvlOneStartPt = new CoordinateManager(4, 6),
			lvlTwoStartPt = new CoordinateManager(4, 2), lvlThreeStartPt = new CoordinateManager(0, 0);
	...
	private enum Directions {
		...
		Directions(final int number) {
			num = number;
		}
	}

	/*******
	 * *default map constructor loads level one *@throws IOException
	 *******/
	...
	/**********
	 * *constructor sets up different levels *@param lvlNum *@throws IOException
	 **********/
	...
	/********
	 * * get current location in the array *@return Room 2d array
	 ********/
	public Room[][] getNav() {
		return navPts;
	}
	...
	/*
	 * public String toString(CoordinateManager nums) { Room place; place =
	 * navPts[nums.getCol()][nums.getRow()]; place.toString();
	 * 
